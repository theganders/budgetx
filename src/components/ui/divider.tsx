...
function Divider({
  ...
  return (
    <div className={cn("relative w-full", height, className)} {...props}>
      {variant === "diagonal" && (
        <div className="text-ds-gray-alpha-400 absolute inset-[0px] [background-image:repeating-linear-gradient(315deg,currentColor_0_1px,transparent_1px_50%)] bg-[size:10px_10px]" />
      )}
      {variant === "fill" && (
